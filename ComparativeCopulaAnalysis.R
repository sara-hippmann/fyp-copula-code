...
data <- read_csv("/Users/sarahippmann/Desktop/thesis resources/thesisdata.csv")
data <- data %>%
...
print(norm_bic)
norm_obs_loglik <- dCopula(cbind(spx_transformed, bnd_transformed, gold_transformed, oil_transformed, re_transformed, crypto_transformed), norm_fit@copula, log=TRUE)
...
print(student_loglik)
student_obs_loglik <- dCopula(cbind(spx_transformed, bnd_transformed, gold_transformed, oil_transformed, re_transformed, crypto_transformed), student_fit@copula, log=TRUE)
...
rv_densities <- RVinePDF(vine_df, fit.rv.sum)
rv_obs_loglik <- log(rv_densities)
...
vuong.p<-c(
  ...
  RVineVuongTest(vine_df,fit.rv.sum.mle$RVM,fit.rv.ind.mle$RVM)$p.value,
  RVineVuongTest(vine_df,fit.cv.sum.mle$RVM,fit.cv.ind.mle$RVM)$p.value,
  RVineVuongTest(vine_df,fit.dv.sum.mle$RVM,fit.dv.ind.mle$RVM)$p.value)
vuong.p.aic<-c(
  ...
  RVineVuongTest(vine_df,fit.rv.sum.mle$RVM,fit.rv.ind.mle$RVM)$p.value.Akaike,
  RVineVuongTest(vine_df,fit.cv.sum.mle$RVM,fit.cv.ind.mle$RVM)$p.value.Akaike,
  RVineVuongTest(vine_df,fit.dv.sum.mle$RVM,fit.dv.ind.mle$RVM)$p.value.Akaike)
vuong.p.bic<-c(
  ...
  RVineVuongTest(vine_df,fit.rv.sum.mle$RVM,fit.rv.ind.mle$RVM)$p.value.Schwarz,
  RVineVuongTest(vine_df,fit.cv.sum.mle$RVM,fit.cv.ind.mle$RVM)$p.value.Schwarz,
  RVineVuongTest(vine_df,fit.dv.sum.mle$RVM,fit.dv.ind.mle$RVM)$p.value.Schwarz)
vuong.stat<-c(
  ...
  RVineVuongTest(vine_df,fit.rv.sum.mle$RVM,fit.rv.ind.mle$RVM)$statistic,
  RVineVuongTest(vine_df,fit.cv.sum.mle$RVM,fit.cv.ind.mle$RVM)$statistic,
  RVineVuongTest(vine_df,fit.dv.sum.mle$RVM,fit.dv.ind.mle$RVM)$statistic)
vuong.stat.aic<-c(
  ...
  RVineVuongTest(vine_df,fit.rv.sum.mle$RVM,fit.rv.ind.mle$RVM)$statistic.Akaike,
  RVineVuongTest(vine_df,fit.cv.sum.mle$RVM,fit.cv.ind.mle$RVM)$statistic.Akaike,
  RVineVuongTest(vine_df,fit.dv.sum.mle$RVM,fit.dv.ind.mle$RVM)$statistic.Akaike)
vuong.stat.bic<-c(
  ...
  RVineVuongTest(vine_df,fit.rv.sum.mle$RVM,fit.rv.ind.mle$RVM)$statistic.Schwarz,
  RVineVuongTest(vine_df,fit.cv.sum.mle$RVM,fit.cv.ind.mle$RVM)$statistic.Schwarz,
  RVineVuongTest(vine_df,fit.dv.sum.mle$RVM,fit.dv.ind.mle$RVM)$statistic.Schwarz)
...
rownames(vuong.table.rcdv)<-c("rv all vs dv all","rv all vs cv all",
                              "cv all vs dv all", "rv all vs gv", "rv all v rv ind all",
                              "cv all v cv ind all", "dv all v dv ind all")
...
#Vuong Test comparing Multivariate Gaussian copula to vine copula
norm_loglik_diff <- rv_obs_loglik - norm_obs_loglik
norm_mean_diff <- mean(norm_loglik_diff)
norm_sd_diff <- sd(norm_loglik_diff) / sqrt(1877)
norm_vuong_stat <- norm_mean_diff / norm_sd_diff
norm_p_val <- 2 * (1 - pnorm(abs(norm_vuong_stat)))
print(norm_vuong_stat)
print(norm_p_val)

#Vuong Test comparing Multivariate Student t copula to vine copula
student_loglik_diff <- rv_obs_loglik - student_obs_loglik
student_mean_diff <- mean(student_loglik_diff)
student_sd_diff <- sd(student_loglik_diff)/sqrt(1877)
student_vuong_stat <- student_mean_diff / student_sd_diff
student_p_val <- 2 * (1 - pnorm(abs(student_vuong_stat)))
print(student_vuong_stat)
print(student_p_val)